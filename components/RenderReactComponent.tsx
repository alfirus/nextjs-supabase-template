...
export default function RenderReactComponent({ componentCode }: {
    ...
    useEffect(() => {
        if (componentCode && containerRef.current) {
            ...
            try {
                ...
                const Component = new Function('React', `return function CustomComponent() { return ${transformedCode}; }`)(React);
